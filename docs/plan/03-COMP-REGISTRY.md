...
This document consolidates all component specifications across all modules, providing a comprehensive inventory of UI components, their patterns, rules, dependencies, and implementation notes.

## Dashboard Components

Components for the main dashboard interface including agent fleet management, activity feeds, and attention queues.
